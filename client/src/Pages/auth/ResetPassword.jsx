      ...
      <div className="div relative z-10">
        ...
        <div className="decoration__image absolute  w-full h-screen overflow-hidden -z-10">
          <svg viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg">
            <path
              fill="#4144EB"
              d="M47.2,-62.9C61.4,-54.6,73.4,-41.2,75.7,-26.4C78,-11.7,70.6,4.4,66,22.3C61.4,40.2,59.5,59.8,49,69.8C38.5,79.8,19.2,80,1.9,77.4C-15.5,74.9,-31,69.4,-45.8,60.9C-60.6,52.3,-74.6,40.5,-80.6,25.4C-86.7,10.3,-84.7,-8.3,-77.9,-24.1C-71.1,-39.9,-59.5,-52.9,-45.7,-61.3C-31.9,-69.7,-16,-73.6,0.3,-73.9C16.5,-74.3,33,-71.2,47.2,-62.9Z"
            ...
            {({ errors, touched }) => (
              <Form className="flex flex-col w-full p-5 lg:p-16 ">
                <Field
                  type="password"
                  name="password"
                  className="auth__input border border-t-0 border-l-0 border-r-0  py-2 outline-none"
                ...
                <Field
                  ...
                  type="password"
                  className="auth__input border border-t-0 border-l-0 border-r-0  py-2  outline-none mt-7"
                ...
                <button
                  type="submit"
                  className="border px-3  py-2 rounded-3xl bg-blue-500 text-white mt-12"
                >
                  Submit
                </button>
              </Form>
