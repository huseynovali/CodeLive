...
import RegisterFormContent from '../../components/AuthContent/RegisterForm'
function Register() {
  return (
    <div className='login__page  w-full h-screen overflow-hidden'>
      ...
      <div className="login__container w-[80vw] h-[70vh] md:h-[40vh] lg:h-[80vh]   m-auto mt-[15vh] md:mt-[30vh] lg:mt-[10vh] relative z-30 rounded-lg flex ">
