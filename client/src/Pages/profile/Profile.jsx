...
function Profile() {
  ...
  const { data: user } = useQuery(
    "userData",
    () => axiosInstance.get(`/user/${userid}/${token}`),
          ...
          <div className=" absolute z-10 w-full h-full">
            ...
            <div className="decoration__image absolute  w-full h-screen overflow-hidden -z-10">
              <svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="#4144EB"
                  d="M49.6,-58.9C64,-46.9,75.3,-31.1,75.3,-15.6C75.3,-0.1,64,15.2,53.2,27.8C42.4,40.4,32.2,50.5,19.5,56.3C6.8,62.1,-8.5,63.6,-24.5,60.7C-40.5,57.7,-57.3,50.2,-64,37.5C-70.7,24.8,-67.3,6.7,-58.2,-4.2C-49.1,-15.2,-34.2,-19.1,-23.5,-31.7C-12.8,-44.4,-6.4,-65.9,5.6,-72.5C17.6,-79.1,35.1,-70.9,49.6,-58.9Z"
            ...
            <div className="decoration__image absolute  w-full h-screen overflow-hidden -z-10">
              <svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="#4144EB"
                  d="M63.4,-35.4C64,-18.6,33.9,-6.6,15.3,2.5C-3.3,11.7,-10.5,18.1,-22.5,13.5C-34.5,8.9,-51.2,-6.6,-48.3,-26.5C-45.3,-46.4,-22.6,-70.8,4.4,-72.2C31.4,-73.6,62.7,-52.1,63.4,-35.4Z"
