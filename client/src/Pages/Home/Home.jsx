    ...
    <div className='home__page overflow-hidden'>
      ...
      <div className="section__2 py-16 px-8 flex justify-between md:flex-row flex-col">
        <div className="left w-full md:w-[30%]  flex-col items-center flex">
          ...
          <h1 className='text-white text-3xl md:text-4xl text-center font-bold hidden md:block'>Code{"<"}ive{"/>"}</h1>
        </div>
        <div className="right w-full md:w-[50%] my-3 md:my-0">
          <h2 className='text-3xl md:text-5xl text-white font-bold'>Start for free</h2>
          ...
          >
            <SwiperSlide className='p-5'>
              <div className="user__thoughts__left ">
                <span className='my-3 block text-xl'><BiSolidQuoteAltLeft /></span>
                <p className='italic'>
                  Thanks to Codelive, Booz Allen has armed our workforce, specifically
            ...
            <SwiperSlide className='p-5'>
              <div className="user__thoughts__left ">
                ...
                <p className='italic'>
                  ...
                  technology and consultant soft skills. We're thankful that once they
                  got in and took their key IT courses on AWS, Azure, Google Cloud, Big Data,
                  and DevOps that they efficiently moved over to Consulting courses to help
                  drive their career forward
                </p>
            ...
            <SwiperSlide className='p-5'>
              <div className="user__thoughts__left ">
                <span className='my-3 block text-xl'><BiSolidQuoteAltLeft /></span>
                <p className='italic'>
                  To stay at the leading edge of IT innovation, your team
                  needs to regularly reinvent its skillset. With CodeLive,
                  I can give my team the space to learn and take the initiative.
                  It means we can produce higher quality work more quickly.
                </p>
            ...
            <SwiperSlide className='p-5'>
              <div className="user__thoughts__left ">
                <span className='my-3 block text-xl'><BiSolidQuoteAltLeft /></span>
                <p className='italic'>
                  CodeLive has been a great platform to stay competitive in the digital transformation of the
                  workplace by offering fresh, relevant, personalized on-demand learning content powered
                  by a dynamic content marketplace.
                </p>
      ...
      <footer className='py-16 flex justify-center'>
        ...
        <div className="footer__right flex w-[40%] m-auto justify-end">
          <h1 className='text-white ml-3 text-lg opacity-80'>© 2023 CodeLive</h1>
        </div>
      </footer>
